...
--
-- Dumping data for table `ModuleSkill`
--

INSERT INTO `ModuleSkill` (`module_id`, `skill_name`) VALUES
...
ALTER TABLE `ModuleSkill`
  ADD PRIMARY KEY (`skill_name`,`module_id`),
  ADD KEY `fk_ModuleSkill_Module` (`module_id`);


ALTER TABLE `ModuleSkill`
  ADD CONSTRAINT `fk_ModuleSkill_Module` FOREIGN KEY (`module_id`) REFERENCES `Module` (`module_id`);
COMMIT;
