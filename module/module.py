...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:root@localhost:3306/module' or 'mysql+mysqlconnector://root@localhost:3306/module' or environ.get('dbURL')
