...
query.set_field("get_all_students", resolve_students)
query.set_field("get_all_students_modules", resolve_students_modules)
query.set_field("get_one_student_module", resolve_student_module)
